    ...
    public partial class SeeThrougWindowsForm : Form
    {
        ...
        private void InitializeServices()
        {
            ...
            _hotkeyManager.UserHotkeyPressed += (s, e) =>
            {
                ...
                UpdateUI(); // Update button state after transparency toggle
            };
            ...
            _hotkeyManager.MoreTransparentHotkeyPressed += (s, e) =>
            {
                ...
                UpdateUI(); // Update button state after transparency change
            };
        ...
        {
            // Simple implementation - just call the service and update UI
            _applicationService.RestoreAllWindows();
            UpdateUI();
        }
